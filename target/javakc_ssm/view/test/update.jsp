        ...
        <form action="${path}/test/update.do" method="post" class="form-horizontal" role="form">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="testName" placeholder="姓名" value="${testEntity.testName}"/>
                    </div>
                    <label class="col-sm-2 control-label" for="ds_name">性别</label>
                    <div class="col-sm-4">
                        <zhg:select codeTp="sex" def="true" cls="form-control" name="testSex" value="${testEntity.testSex}"></zhg:select>
                    </div>
                </div>
                <div class="form-group">
